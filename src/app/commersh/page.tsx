        ...
        <div className="w-full max-w-4xl px-4 sm:px-8 py-8">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="relative">
              <div className="relative aspect-square w-full max-w-md mx-auto bg-gray-800/30 rounded-xl p-6">
            ...
            <div className="space-y-6 text-center md:text-left">
              <div className="pt-2">
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">DRIPPER</h1>
